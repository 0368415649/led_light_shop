...
if( isset($_POST['pass']) ){
    $sql="UPDATE `admin` SET `password`='".$_POST['pass']."' WHERE 1";
...
?>                  
                <div class="admin_is bg-dark">Change Password</div>
                ...
                <form style="    padding: 40px 400px;" class="main_form row" id="user_name" method="post" action="">
                    ...
                    <div style="margin-bottom:30px;" class=" main_flex  box">
                        ...
                        <input rules="min:5" type="text" name="pass" class="form-control" >
...
<script>
    validate('#user_name'); 
    document.querySelector('#title').innerHTML = "CHANGE PASSWORD";
