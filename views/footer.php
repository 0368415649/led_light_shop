...
<div class="footer">
    <div class="row">
        <div class="col-lg-4 col-sm-6 boxz">
        ...
        <div class="col-lg-2 col-sm-3 boxz">
            ...
            <ul class="">
                ...
                <li class="footer-item"><a href="?route=contact">About us</a></li>

                <li class="footer-item"><a href="?route=Privacy_Policy">Privacy Policy</a></li>
            </ul>
        </div>
